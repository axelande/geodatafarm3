...
def test_import_plant_text(gdf:GeoDataFarm):
    ...
    idx = gdf.save_planting.importer.ITD.CBField.findText('test_field')
    gdf.save_planting.importer.ITD.CBField.setCurrentIndex(idx)
...
def test_import_harvest_text(gdf:GeoDataFarm):
    ...
    idx = gdf.save_harvesting.importer.ITD.CBField.findText('test_field')
    gdf.save_harvesting.importer.ITD.CBField.setCurrentIndex(idx)
