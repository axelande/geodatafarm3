...
class Ui_ImportHarvestDialogBase(object):
    def setupUi(self, ImportHarvestDialogBase):
        ...
        self.button_box = QtWidgets.QDialogButtonBox(ImportHarvestDialogBase)
        ...
        self.add_input_file = QtWidgets.QPushButton(ImportHarvestDialogBase)
        self.add_input_file.setGeometry(QtCore.QRect(11, 10, 85, 23))
        self.add_input_file.setObjectName(_fromUtf8("add_input_file"))
        self.TWColumnNames = QtWidgets.QTableWidget(ImportHarvestDialogBase)
        self.TWColumnNames.setGeometry(QtCore.QRect(10, 71, 401, 221))
        self.TWColumnNames.setEditTriggers(QtWidgets.QAbstractItemView.AnyKeyPressed)
        ...
        self.pButInsertDataIntoDB = QtWidgets.QPushButton(ImportHarvestDialogBase)
        ...
        self.label_4 = QtWidgets.QLabel(ImportHarvestDialogBase)
        self.label_4.setGeometry(QtCore.QRect(20, 300, 491, 31))
        self.label_4.setWordWrap(True)
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.ComBHarvestCol = QtWidgets.QComboBox(ImportHarvestDialogBase)
