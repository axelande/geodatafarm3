...
class Ui_GeoDataFarmDockWidgetBase(object):
    def setupUi(self, GeoDataFarmDockWidgetBase):
        ...
        self.pb_add_input_file = QtWidgets.QPushButton(self.dockWidgetContents)
        ...
        self.pb_run_analyse = QtWidgets.QPushButton(self.dockWidgetContents)
        ...
        self.LWtable_names = QtWidgets.QListWidget(self.dockWidgetContents)
        ...
        self.pb_uppdate_list = QtWidgets.QPushButton(self.dockWidgetContents)
        ...
        self.pb_add_harvest_file = QtWidgets.QPushButton(self.dockWidgetContents)
        ...
        self.pb_remove_item = QtWidgets.QPushButton(self.dockWidgetContents)
        ...
        self.pb_add_input_file_2 = QtWidgets.QPushButton(self.dockWidgetContents)
        ...
        self.pb_add_new_farm = QtWidgets.QPushButton(self.dockWidgetContents)
        ...
        self.farm_name = QtWidgets.QLabel(self.dockWidgetContents)
        ...
        self.pb_add_harvest_file_2 = QtWidgets.QPushButton(self.dockWidgetContents)
        ...
        self.pb_add_2_canvas = QtWidgets.QPushButton(self.dockWidgetContents)
